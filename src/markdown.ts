...
// prose passes through untouched. Deterministic: the judge's verbatim quotes anchor
// against exactly this rendering, frozen on the Decision. Null values are absence of
// data, not data — they carry nothing to render.
...
// markdown(field) — structured YAML → bullets; anything else (prose, or text that only
