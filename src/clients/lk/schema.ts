...
export interface Card {
	/**
	 * Near-identity: present on every live profile. Required — a null here means the top-card parse broke (class rotation / authwall / headless-blank), which must fail loud rather than return a nameless record.
	 */
	name: string | null;
	/**
	...
	profileUrl: string;
	/**
	 * Top-card current-employer chip; null when the profile surfaces no company chip (employer then only in get_profile_experience).
	 */
